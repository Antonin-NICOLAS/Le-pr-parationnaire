...
const EmailTwoFactorActivation = (t, user, code, expiration) => {
  const template = `
      <!DOCTYPE html>
      <html
                                  ...
                                  >
                                    <tr>
                                      <td class="pad">
                                        ...
                                        >
                                          <p style="margin: 0">
                                            Vous voulez ajouter la méthode de double authentification par email sur votre compte&nbsp;<strong
                                              >Le Préparationnaire</strong
                                            >. Pour activer cette méthode, veuillez saisir le code de vérification ci-dessous :
                                          </p>
                                        </div>
                                      </td>
                                    </tr>
...
module.exports = { EmailTwoFactorActivation }
