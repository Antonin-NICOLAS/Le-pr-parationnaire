...
const ChangeEmailStep1 = (t, user, code) => {
  const template = `
      <!DOCTYPE html>
      <html
                                  ...
                                  >
                                    <tr>
                                      <td class="pad">
                                        ...
                                        >
                                          <p style="margin: 0">
                                            Vous avez demandé à changer l'adresse email associée à votre compte &nbsp;<strong
                                              >Le Préparationnaire</strong
                                            >. Avant de pouvoir la modifier, vous devez remplir cette étape de sécurité. Voici votre code de vérification à 6
                                            chiffres :
                                          </p>
                                        </div>
                                      </td>
...
module.exports = { ChangeEmailStep1 }
