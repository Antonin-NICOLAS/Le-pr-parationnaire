...
const ChangeEmailStep2 = (t, user, code) => {
  const template = `
      <!DOCTYPE html>
      <html
                                      ...
                                      <td class="pad">
                                        ...
                                        >
                                          <p style="margin: 0">
                                            ...
                                            >. Pour confirmer le changement, veuillez vérifier votre nouvelle adresse email avec le code de vérification à 6
                                            chiffres suivant :
                                          </p>
                                        </div>
                                      </td>
...
module.exports = { ChangeEmailStep2 }
