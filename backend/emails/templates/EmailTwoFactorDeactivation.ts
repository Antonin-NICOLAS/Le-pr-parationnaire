                                  ...
                                  >
                                    <tr>
                                      <td class="pad">
                                        ...
                                        >
                                          <p style="margin: 0">
                                            Vous voulez désactiver la méthode de double authentification par email sur votre compte&nbsp;<strong
                                              >Le Préparationnaire</strong
                                            >. Pour désactiver cette méthode, veuillez saisir le code de vérification ci-dessous :
                                          </p>
                                        </div>
                                      </td>
                                    </tr>
...
export default EmailTwoFactorActivation
